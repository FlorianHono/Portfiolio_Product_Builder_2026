export const translations = {
  fr: {
    ...
    stack: {
      ...
      page: {
        ...
        labels: {
          ...
          info: "Chaque outil est choisi pour sa capacité à s'intégrer <br/>dans un écosystème automatisé et modulaire.",
          dispTech: "Disponibilité Tech",
          date: "AVRIL 2026"
        }
      }
    },
    ...
    mentions: {
      ...
      seoDesc: "Informations légales concernant le site de Florian Honoré.",
      headerLabel: "Informations légales",
      ...
      sections: {
        ...
        s2: {
          title: "Hébergement",
          lines: ["Hostinger International Ltd.", "61 Lordou Vironos Street, 6023 Larnaca, Chypre", "Site : "]
        },
        s3: {
          title: "Propriété intellectuelle",
          content: "L'ensemble du contenu de ce site (textes, visuels, structure, code) est la propriété exclusive de Florian Honoré, sauf mention contraire. Toute reproduction, distribution ou utilisation sans autorisation préalable est strictement interdite."
        },
        s4: {
        ...
        s5: {
          title: "Cookies",
          content: "Ce site peut utiliser des cookies techniques nécessaires à son bon fonctionnement. Aucun cookie publicitaire ou de tracking tiers n'est utilisé sans votre accord."
        },
        s6: {
          title: "Responsabilité",
          content: "Florian Honoré s'efforce de maintenir les informations de ce site à jour et exactes, mais ne peut garantir leur exhaustivité ni leur exactitude à tout moment. Les liens vers des sites tiers sont fournis à titre indicatif. Florian Honoré n'est pas responsable de leur contenu."
        },
        s7: {
          title: "Droit applicable",
          content: "Les présentes mentions légales sont régies par le droit français. Tout litige relève de la compétence des tribunaux français."
        }
      }
    }
  },
  en: {
    ...
    stack: {
      ...
      page: {
        ...
        labels: {
          ...
          cms: "CMS",
          prototyping: "PROTOTYPING",
          info: "Each tool is chosen for its ability to integrate <br/>into an automated and modular ecosystem.",
          dispTech: "Tech Availability",
          date: "APRIL 2026"
        }
      }
    },
    ...
    mentions: {
      ...
      seoDesc: "Legal information regarding Florian Honoré's website.",
      headerLabel: "Legal Information",
      ...
      sections: {
        ...
        s2: {
          title: "Hosting",
          lines: ["Hostinger International Ltd.", "61 Lordou Vironos Street, 6023 Larnaca, Cyprus", "Site: "]
        },
        s3: {
          title: "Intellectual Property",
          content: "All content on this site (text, visuals, structure, code) is the exclusive property of Florian Honoré, unless otherwise stated. Any reproduction, distribution, or use without prior authorization is strictly prohibited."
        },
        s4: {
          title: "Personal Data",
          content: "This site does not collect any personal data without your explicit consent. Information submitted via the contact form is used solely to respond to your inquiries and is never shared with third parties. Under the GDPR and the Data Protection Act, you have the right to access, rectify, and delete your data. To exercise this right: "
        },
        s5: {
          title: "Cookies",
          content: "This site may use technical cookies necessary for its proper functioning. No advertising or third-party tracking cookies are used without your consent."
        },
        s6: {
          title: "Liability",
          content: "Florian Honoré strives to keep the information on this site accurate and up-to-date, but cannot guarantee its completeness or accuracy at all times. Links to third-party sites are provided for informational purposes. Florian Honoré is not responsible for their content."
        },
        s7: {
          title: "Applicable Law",
          content: "These legal notices are governed by French law. Any dispute falls under the jurisdiction of French courts."
        }
      }
    }
  }
