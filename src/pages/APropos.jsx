...
export default function APropos() {
  return (
    <div className="w-full">
      <SEO 
        title="À Propos" 
        description="En savoir plus sur Florian Honoré : son parcours de l'infographie 3D au product building, sa vision et ses expériences."
      />
      ...
      <section className="h-[500px] border-y border-outline-variant overflow-hidden relative group">
        ...
        <div className="absolute bottom-12 md:bottom-20 left-6 md:left-12 lg:left-24">
          <h2 className="font-inter font-black text-white text-display-2 md:text-display-1 uppercase tracking-tighter leading-none">
