        ...
        <div className="max-w-[1600px] mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 lg:gap-8">
            {[
              ...
              <div 
                key={i} 
                className="bg-[#1a0800] border border-primary/20 p-8 hover:border-primary/60 hover:bg-[#240c00] transition-all duration-300 relative overflow-hidden group hover:-translate-y-1 flex flex-col justify-between min-h-[180px]"
              >
